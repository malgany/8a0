    ...
    <main className="home-wrap privacy-wrap tx-paper">
      <header className="home-head">
        <nav className="home-nav">
          <Link className="btn btn-secondary" href={localePath(locale, "/")}>
            {locale === "pt" ? "voltar ao 7a0" : locale === "es" ? "volver a 7a0" : "back to 7a0"}
          </Link>
      ...
      <article className="privacy-card sticker">
        <span className="eyebrow">7a0</span>
        ...
        <section>
          <h2>Dados</h2>
          <p>
            O 7a0 não exige cadastro para jogar. Preferências locais ficam no navegador, e links
        ...
        <section>
          ...
          <p>
            Além de publicidade configurável, o rodapé pode apontar para Ko-fi e links de contato/anúncio.
            Essas integrações são controladas por variáveis de ambiente neste clone.
          </p>
        </section>
      </article>
    </main>
